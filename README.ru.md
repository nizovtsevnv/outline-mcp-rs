...
Скачайте готовый бинарный файл с [GitHub Releases](https://github.com/nizovtsevnv/outline-mcp-rs/releases) или соберите из исходного кода.
...
```json
{
  "mcpServers": {
    "Outline knowledge base": {
      "command": "полный-путь-к-исполняемому-файлу-outline-mcp",
      "env": {
